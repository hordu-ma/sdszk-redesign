<template>
  <div class="user-roles">
    ...
    <div class="roles-grid">
      <a-row :gutter="[16, 16]">
        <a-col v-for="role in filteredRoles" :key="role.id" :xs="24" :sm="12" :md="8" :lg="6">
          <a-card
            :hoverable="true"
            class="role-card"
            ...
            <div class="role-content">
              ...
              <div class="role-permissions">
                <div class="permissions-preview">
                  ...
                  <a-tag v-if="role.permissions.length > 3" size="small" color="default">
              ...
              <div class="role-actions">
                <a-button type="link" size="small" @click="viewRoleDetails(role)">
                  查看详情
                </a-button>
                <a-button
              ...
              <div class="role-meta">
                <span class="created-time"> 创建于 {{ formatDate(role.createdAt) }} </span>
              </div>
            </div>
          </a-card>
        </a-col>
    ...
    >
      ...
      >
        ...
        <a-form-item label="显示名称" name="displayName">
          <a-input v-model:value="roleForm.displayName" placeholder="请输入显示名称（中文）" />
        </a-form-item>
    ...
    <!-- 角色详情模态框 -->
    <a-modal v-model:open="detailModalVisible" title="角色详情" :footer="null" width="600px">
...
const expandAllPermissions = () => {
  if (allExpanded.value) {
    ...
    expandedPermissionKeys.value = permissionTree.value.map(node => node.name)
  }
