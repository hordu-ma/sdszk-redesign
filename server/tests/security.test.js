...
import { getHelmetConfig, getCSPConfig, generateNonce, cspViolationHandler } from '../config/security.js';
...
describe('Security Configuration Tests', () => {
  ...
  describe('getHelmetConfig', () => {
    ...
    it('should include nonce in production config', () => {
      ...
      expect(config.contentSecurityPolicy.directives.scriptSrc).toContain(`'nonce-${nonce}'`);
    });
  });
