...
# 设置环境变量（请替换为您的实际值）
export MONGODB_URI="mongodb+srv://您的用户名:您的密码@cluster.mongodb.net/您的数据库名"
export JWT_SECRET="您的JWT密钥"
export FRONTEND_URL="https://您的GitHub用户名.github.io/sdszk-redesign"
export NODE_ENV="production"

# 重新启动PM2并传入环境变量
pm2 start app.js --name "sdszk-backend" --update-env
echo $MONGODB_URI
echo $JWT_SECRET
echo $FRONTEND_URL
```
