...
export const validate = schema => {
  return (req, res, next) => {
    ...
    const joiSchema = typeof schema.validate === 'function' ? schema : Joi.object(schema)
...
export const validateParams = schema => {
  return (req, res, next) => {
    ...
    console.log('validateParams - Schema has validate:', typeof schema.validate)
    ...
    console.log('validateParams - joiSchema has validate:', typeof joiSchema.validate)
